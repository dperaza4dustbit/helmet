...
const (
	...
	// BundleTypesSupported lists which placements are valid: "product", "integration",
	// comma-separated combinations, or "both". Only product placement is used for Helm installs.
